	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'skill-gradient': {
					start: 'hsl(var(--skill-gradient-start))',
					end: 'hsl(var(--skill-gradient-end))'
				},
				'project-gradient': {
					start: 'hsl(var(--project-gradient-start))',
					end: 'hsl(var(--project-gradient-end))'
				}
			},
			backgroundImage: {
				...
				'project-gradient': 'linear-gradient(135deg, hsl(var(--project-gradient-start)), hsl(var(--project-gradient-end)))',
